...
public class UserResource {
	...
	// http://localhost:8080/Ex09/webresources/user
	@GET
	...
	// http://localhost:8080/Ex09/webresources/user/check?usermail=tuan@gmail.com&userpass=1234
	@GET
	@Path("check")
	@Produces(MediaType.APPLICATION_JSON)
	...
	// http://localhost:8080/Ex09/webresources/user/searchLastName?name=uy
	@GET
	@Path("searchLastName")
	@Produces(MediaType.APPLICATION_JSON)
