...
public class BaiVietResource {
	...
	// http://localhost:8080/Ex09/webresources/baiviet/
	@GET
	...
	// http://localhost:8080/Ex09/webresources/baiviet/all
	@GET
	@Path("/all")
	@Produces(MediaType.APPLICATION_JSON)
	...
	// http://localhost:8080/Ex09/webresources/baiviet/page?firstResult=2&maxResult=5
	@GET
	@Path("/page")
	@Produces(MediaType.APPLICATION_JSON)
	...
	// http://localhost:8080/Ex09/webresources/baiviet/mabv/1
	@GET
	@Path("mabv/{id}")
	@Produces(MediaType.APPLICATION_JSON)
	...
	// http://localhost:8080/Ex09/webresources/baiviet/count
	@GET
	@Path("/count")
	@Produces(MediaType.APPLICATION_JSON)
	...
	// http://localhost:8080/Ex09/webresources/baiviet/create
	...
	// http://localhost:8080/Ex09/webresources/baiviet/update/29
	// x-www-form-urlencoded
	...
	// http://localhost:8080/Ex09/webresources/baiviet/delete/28
	@DELETE
	@Path("/delete/{id}")
